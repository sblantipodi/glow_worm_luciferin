...
const char* ssid = "XXX";  //da configurare
const char* password = "XXX";  //da configurare
const char* mqtt_server = "192.168.1.XX";  //da configurare
const char* mqtt_username = "XXX";  //da configurare
const char* mqtt_password = "XXX";  //da configurare
