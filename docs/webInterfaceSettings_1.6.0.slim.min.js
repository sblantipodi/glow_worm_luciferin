...
function callDevice() {
    var payload = {
        ...
        ethd: ($("#ethCbx").prop("checked") ? '0' : $('#ethd').val()),
...
sleep(100).then(() => {
    ...
    $('#ethd').append(new Option("WT32-ETH01", "1"));
    $('#ethd').append(new Option("WT32-ETH02", "2"));
    $('#ethd').append(new Option("WT32-ETH03", "3"));
});
