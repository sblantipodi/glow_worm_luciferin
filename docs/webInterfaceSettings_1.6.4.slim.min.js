...
<div id="customEthGpios" style="display:none; margin-top:10px;">
  <label class="form-label"><strong>CUSTOM W5500 GPIOs</strong></label>
  ...
  <div class="row g-2 mt-1">
    ...
    <div class="col-4 form-floating">
      <input type="number" class="form-control form-control-sm" id="interrupt" placeholder="INT">
      <label for="interrupt">INT</label>
    </div>
    <div class="col-4 form-floating">
      <input type="number" class="form-control form-control-sm" id="rst" placeholder="RST">
...
$('#ethd').on('change', function () {
    ...
    $('#mosi, #miso, #sclk, #cs, #int, #rst').prop('required', isCustom);
});
...
function callDevice() {
    ...
    if ($('#ethd').val() == 100) {
        ...
        payload.cs = $('#cs').val();
        payload.interrupt = $('#interrupt').val();
        payload.rst = $('#rst').val();
    }
    console.log(payload);
    const http = new XMLHttpRequest();
