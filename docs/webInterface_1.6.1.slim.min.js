    ...
    poll(() => new Promise(() => {
        ...
        http.onload = () => {
            ...
            if (prefs.cp.length > 0) {
                ...
                setBrightness(colorPicker, Math.round((100*prefs.brightness)/255));
            }
...
function asCBAction(cbAs) {
    ...
    if (confirm(strConfirm)) {
        ...
        http.onload = () => {
            ...
            secondHttp.send();
            secondHttp.onload = () => console.log(secondHttp.responseText);
        }
    }
}
function setBrightness(colorPicker, brightness) {
