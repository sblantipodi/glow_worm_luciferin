...
function evaluateValues() {
    if (!$('#ldrEnabled')[0].checked) {
        $('#ldrContinuous')[0].checked = false;
        $('#ldrInterval')[0].disabled = true;
        $('#ldrMin')[0].disabled = true;
        $('#cal')[0].disabled = true;
        $('#rst')[0].disabled = true;
    } else {
        $('#ldrContinuous')[0].disabled = false;
...
sleep(100).then(() => {
    ...
    $('#ldrTurnOff').append(new Option("Continuous", "0"));
    $('#ldrTurnOff').append(new Option("5", "5"));
    $('#ldrTurnOff').append(new Option("15", "15"));
    $('#ldrTurnOff').append(new Option("30", "30"));
    $('#ldrTurnOff').append(new Option("45", "45"));
    $('#ldrTurnOff').append(new Option("60", "60"));
