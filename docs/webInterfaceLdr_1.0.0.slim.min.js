...
sleep(100).then(() => {
    ...
    $('#ldrMax').append(new Option("10%", "10"));
    $('#ldrMax').append(new Option("20%", "20"));
    $('#ldrMax').append(new Option("30%", "30"));
    $('#ldrMax').append(new Option("40%", "40"));
    $('#ldrMax').append(new Option("50%", "50"));
    $('#ldrMax').append(new Option("60%", "60"));
    $('#ldrMax').append(new Option("70%", "70"));
    $('#ldrMax').append(new Option("80%", "80"));
    $('#ldrMax').append(new Option("90%", "90"));
    $('#ldrMax').append(new Option("100%", "100"));
});
