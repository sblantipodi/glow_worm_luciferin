...
//        whitetemp: (((kelvinPicker.color.kelvin/100)|0)),
        allInstances: 1
    }
    return payload;
}
...
//  if ((((kelvinPicker.color.kelvin/100)|0)) == 65) { $("#ut").show(); } else { $("#ut").hide(); }
//});
...
colorPicker.on(['input:end'], function(color) {
    callDevice(JSON.stringify(createPayload()));
    console.log(kelvinPicker.color.kelvin);
});
const sleep = (s) => {
...
sleep(100).then(() => {
  ...
  $("#ut").text("Uncorrected Temperature")
