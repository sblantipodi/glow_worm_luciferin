...
function showToast(message, contextClass) {
    ...
    var toastHTML = `
    <div class="toast ${contextClass}" role="alert" aria-live="assertive" aria-atomic="true" data-delay="5000" style="position: absolute; top: 0; right: 0; z-index: 1051;">
        <div class="toast-body">
            ${message}
        </div>
    </div>`;
    var toastContainer = document.getElementById('toastContainer').children[0];
    toastContainer.insertAdjacentHTML('beforebegin', toastHTML);
        ...
        http.onload = () => {
            ...
            secondHttp.onload = () => {
                ...
                if (secondHttp.responseText === "Stored") {
                    ...
                    showToast('Error while saving', 'bg-error text-white');
                }
            }
        }
    }
