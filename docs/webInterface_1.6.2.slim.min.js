    ...
    var colorPicker = new iro.ColorPicker('#picker', {
        width: Math.min((320 * physicalWidth) / 1440, 320),
        color: '#0091ff',
        layout: [
            {
        ...
        layout: [
            {
                ...
                options: {
                    sliderType: 'value',
					sliderSize: Math.min((26 * physicalWidth) / 1440, 26)
                }
            }
        ]
    });
	// Math.max((360 * physicalWidth) / 1440, 360)
        ...
        layout: [
            {
                ...
                options: {
                    sliderType: 'kelvin',
                    sliderSize: Math.min((40 * physicalWidth) / 1440, 40),
                    minTemperature: 2000,
    ...
    sleep(100).then(() => {
        ...
        $('#effectSelect').append(new Option(physicalWidth, physicalWidth));
        $('#effectSelect').append(new Option("Music mode (Rainbow music)", "Music mode (Rainbow music)"));
        poll();
