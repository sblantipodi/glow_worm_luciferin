...
sleep(100).then(() => {
    poll();
    $('#colorMode').append(new Option("RGB", "0"));
    $('#colorMode').append(new Option("RGBW (Accurate)", "1"));
    $('#colorMode').append(new Option("RGBW (Brighter)", "2"));
    $('#colorMode').append(new Option("RGBW (RGB only)", "3"));  
});
